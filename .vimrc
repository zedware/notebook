...
"=ctags
" The default ctags is from emacs, which has different options. So install the universal one.
"   $ sudo apt-get install universal-ctags
" And the option `extra' becomes `extras' in recent versions.
let Tlist_Ctags_Cmd = "/usr/bin/ctags"
map <F4> :TlistToggle<cr>
map <F8> :!/usr/bin/ctags -R --c++-kinds=+p --fields=+iaS --extras=+q .<CR>
